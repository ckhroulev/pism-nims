...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\linewidth}
      \only<1>{\includegraphics[width=0.75\linewidth]{grid-1}}
      \only<2>{\includegraphics[width=0.75\linewidth]{grid-2}}
      \only<3>{\includegraphics[width=0.75\linewidth]{grid-3}}
      \only<4>{\includegraphics[width=0.75\linewidth]{grid-4}}
      \only<5>{\includegraphics[width=0.75\linewidth]{grid-5}}
    \end{column}
  \end{columns}
